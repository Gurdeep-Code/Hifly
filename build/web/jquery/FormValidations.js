...
function nameNOTE() {
  document.getElementById("invalidMSG").innerHTML = "INFO: Name should be in alphabet only.";
}


function emailNOTE() {
  document.getElementById("invalidMSG").innerHTML = "INFO: Use of @ is mandatory.";
}


function phoneNOTE() {
  document.getElementById("invalidMSG").innerHTML = "INFO: It should require 10 numeric values.";
}


function passNOTE() {
  document.getElementById("invalidMSG").innerHTML = "INFO: It must be of minimum 8 characters.";
}

function clearmsg() {
  document.getElementById("invalidMSG").innerHTML = " ";
  document.getElementById("invalidMSG1").innerHTML = " ";
}
